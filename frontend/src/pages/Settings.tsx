...
export default function Settings() {
  ...
  return (
    <div>
      <div className="mb-4">
        <h1 className="text-xl font-semibold text-[#eeeeee] mb-1">设置</h1>
        <p className="text-[13px] text-[#808080]">配置 QMT、AI 及服务参数</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card title="QMT 配置">
          <div className="space-y-3">
            <div>
              <label className="block text-xs text-[#808080] mb-1">MiniQMT 路径</label>
              <Input
                value={form.qmt_path}
            ...
            <div>
              <label className="block text-xs text-[#808080] mb-1">数据目录</label>
              <Input
        ...
        <Card title="AI 配置">
          <div className="space-y-3">
            <div>
              <label className="block text-xs text-[#808080] mb-1">API Key</label>
              <Input
                type="password"
            ...
            <div>
              <label className="block text-xs text-[#808080] mb-1">Base URL</label>
              <Input
        ...
        <Card title="服务配置">
          <div className="space-y-3">
            <div>
              <label className="block text-xs text-[#808080] mb-1">后端端口</label>
              <Input
                type="number"
            ...
            <div>
              <label className="block text-xs text-[#808080] mb-1">前端端口</label>
              <Input
                type="number"
            ...
            {currentConfig ? (
              Object.entries(currentConfig).slice(0, 8).map(([key, value]) => (
                <div key={key} className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-[#eeeeee] font-mono truncate max-w-[200px] ml-2">
              ...
              <p className="text-xs text-[#555555] py-2">加载中...</p>
            )}
          </div>
        </Card>
      </div>
